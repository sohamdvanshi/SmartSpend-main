...
from ml_model import load_expense_classifier, predict_expense_category
import pdfplumber
import PyPDF2
import fitz
import platform
...
class BillExtractor:
    def __init__(self):
        ...
        if self.expense_model:
            ...
            print("⚠️ Expense classifier not loaded")
    ...
    def extract_dates(self, text):
        ...
        formatted_dates = [f"{d['date']} (conf: {d['confidence']:.1f})" for d in dates]
        print(f"📅 All extracted dates: {formatted_dates}")
